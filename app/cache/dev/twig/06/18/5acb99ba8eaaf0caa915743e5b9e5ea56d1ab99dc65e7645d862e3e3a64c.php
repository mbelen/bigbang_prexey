...
/* BackendAdminBundle:Modelo:edit.html.twig */
class __TwigTemplate_06185acb99ba8eaaf0caa915743e5b9e5ea56d1ab99dc65e7645d862e3e3a64c extends Twig_Template
{
    ...
    <form class=\"form-horizontal\" id=\"tab\" method=\"post\" novalidate  ";
        ...
        echo " action=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("modelo_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" >
...
";
    ...
    {
        return "BackendAdminBundle:Modelo:edit.html.twig";
    }
